...
int main(int argc, char *argv[]) {
    fprintf(stderr, "GEMINI_DEBUG: main function started\n");
    // Handle --version flag
    ...
    fprintf(stderr, "GEMINI_DEBUG: After software_health_init\n");
    ...
    fprintf(stderr, "GEMINI_DEBUG: Before creating phonebook fetcher thread\n");
    ...
    fprintf(stderr, "GEMINI_DEBUG: Before creating status updater thread\n");
    ...
    fprintf(stderr, "GEMINI_DEBUG: Before creating passive safety thread\n");
    ...
    fprintf(stderr, "GEMINI_DEBUG: Before creating SIP UDP socket\n");
    ...
    fprintf(stderr, "GEMINI_DEBUG: Before binding to UDP port\n");
    ...
    fprintf(stderr, "GEMINI_DEBUG: Entering main SIP message processing loop\n");
